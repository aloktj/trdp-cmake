 ...
 *      A 2020-01-10: Ticket #293 Minor fix in the macro, added spaces to avoid " to be part of the final string.
 *      BL 2020-01-10: Ticket #293 Avoid having version numbering in different places! Makro for version string (DLL) changed.
 *      A 2019-11-14: Ticket #293 Add version to TCNOpen dll <-- !!! should be rejected! Use the function in tlc_if.c !!!
