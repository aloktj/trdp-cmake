    ...
    UINT8               *pData)
{
    ...
    //A copy opTrnTopoCnt is not working, opVehList already allocated for 63 vehicles
    ...
    UINT32              dataSize)
{
    ...
    //A fix, shall we support no closed consist?
    ...
    TRDP_LABEL_T        *pCstId)
{
    ...
    //A fix, entry 0 is always own cst
